...
<!--    <script src="../../../Chart.Scatter.js" type="text/javascript"> </script> -->
...
<script type="text/javascript">
    ...
    // borrowed from Prosodic Harmony project
            ...
            function drawDateMetresChartJSChart()
            {
                ...
                // {} not [] ? for object http://stackoverflow.com/questions/30473933/uncaught-typeerror-cannot-read-property-draw-of-undefined

                for (var i = 0; i > dates.length; i++)  // put all dates to x and metres to y
                    {
                        dateMetresxy[i] = new xyValue(dates[i],metres[i]);
                    }
                    
                //var data = {label:'total metres',strokeColor: '#fff', data:dateMetresxy};
                var data = {label:'total metres',strokeColor: '#fff', type: 'scatter', 
                 data: {
        datasets: [{
            label: 'Metres/date',
            data: [{
//                x: new moment(new Date('2016-01-01')),
                x: new Date('2016-01-01'),
                y: 0
            }, {
//                x: new moment(new Date('2016-02-01')),
                x: new Date('2016-02-01'),
                y: 10
            }, {
//                x: new moment(new Date('2016-03-01')),
                x: new Date('2016-03-01'),
                y: 5
            }]        
                }]}};

// https://github.com/chartjs/Chart.js/issues/1855
                var options = {
//                    type:'line', 
//                    showScale:true, 
                    scales:{xAxes: 
...
//                        isoWeekday: 'true',
                ...
                //new Chart(context).Scatter(data,options);
                // make chart here !
                new Chart(context,data,options);
...
<canvas id="shiftchart" width="200" height ="200"></canvas>
<canvas id="datemetreschart" width="200" height ="200"></canvas>
